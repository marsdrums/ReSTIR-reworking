...
The indirect diffuse computation starts by gathering color samples. The gathering is performed in two ways:
...
### 2) Gathering samples from the environment map
...
In general, the diffuse component computation has been extensively reworked since the released version of the "gi" pass. This is a side-by-side comparison of old diffuse vs new diffuse:
